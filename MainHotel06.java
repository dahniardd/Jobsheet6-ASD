...
public class MainHotel06 {
    public static void main(String[]args){
        ...
        Hotel06 m5 = new Hotel06("Nusa", "Jakarta", 500000, (byte) 5);
        ...
        System.out.println("Data Harga setelah sorting desc menggunakan Bubble Sort = ");
        list.bubbleSort();
        list.tampil();

        System.out.println("Data Rating setelah sorting desc menggunakan Selection Sort  = ");
        list.selectionSort();
        list.tampil();
